<%@ Page Title="" Language="C#" MasterPageFile="~/NAV.Master" AutoEventWireup="true" CodeBehind="Scheme.aspx.cs" Inherits="NAV.Scheme.Scheme" MaintainScrollPositionOnPostback="true" %>
...
<table width="100%">       
    ...
    <tr>
        <td>
            <uc3:ucSwitchDetails ID="ucSwitchDetails1" runat="server" />
        </td>
    </tr>
</table>
</asp:Content>
