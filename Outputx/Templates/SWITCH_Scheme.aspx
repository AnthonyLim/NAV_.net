<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SWITCH_Scheme.aspx.cs" Inherits="NAV.Output.Templates.SWITCH_Scheme" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <title></title>
...
<body style="font-size:10px;">
    ...
    <div>
        <table style="border-collapse: collapse; border-spacing: 0;padding:0;margin:0;" border=0 cellpadding=0 cellspacing=0>
            <thead>
        ...
        <table border=1>
            <thead>
                <tr>
                    <th align="center"><strong>Fund Company</strong></th>
                    <th align="center"><strong>Fund Name</strong></th>
                    <th align="center"><strong>Insurance Company ID</strong></th>
                    <th align="center"><strong>SEDOL</strong></th>
                    <th align="center"><strong>% of Portfolio</strong></th>
                </tr>
            </thead>
            <tbody>{^PortfolioHoldings$}</tbody>
        </table>
        <br />
        <h4 style="font-weight:bold;">Contribution Allocations:</h4>
